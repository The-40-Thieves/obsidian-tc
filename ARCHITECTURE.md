...
**162 governed capabilities**, grouped by access scope.
...
- [`docs/G2.1-tools.md`](docs/G2.1-tools.md) — the 162-tool surface specification (extended additively post-1.0)

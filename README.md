...
✅ **Shipped — v1.21.0** (2026-08-02). Published to npm as provenance-signed packages, with a container image at `ghcr.io/the-40-thieves/obsidian-tc:1.21.0`. The surface is **159 tools across 31 domains**, presented by default via the triad facade described above.

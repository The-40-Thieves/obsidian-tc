...
![Status: Shipped v1.28.0](https://img.shields.io/badge/Status-Shipped_v1.28.0-success)
...
✅ **Shipped — v1.28.0** (2026-08-02). Published to npm as provenance-signed packages, with a container image at `ghcr.io/the-40-thieves/obsidian-tc:1.28.0`. The surface is **163 tools across 31 domains**, presented by default via the triad facade described above.

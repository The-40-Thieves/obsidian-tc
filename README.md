...
✅ **Shipped — v1.11.0** (2026-07-15). Published to npm as provenance-signed packages, with a container image at `ghcr.io/the-40-thieves/obsidian-tc:1.11.0`. The surface is **150 tools across 31 domains**, presented by default via the triad facade described above.

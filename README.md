...
![Status: Shipped v1.3.5](https://img.shields.io/badge/Status-Shipped_v1.3.5-success)
...
|---|---|---|---|---|
| **obsidian-tc** | ~105 (3-tool facade) | FTS5 BM25 · vector (vec0) · GraphRAG RRF | JWT (HS256/JWKS) + per-vault folder ACL + HITL elicit | OTel + Prometheus + CloudEvents |

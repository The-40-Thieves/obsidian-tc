...
one or more Obsidian vaults: **142 capabilities across 31 domains**, every call
...
By default the server advertises **three meta-tools**, not a wall of 142. This
...
want to do. Counts are approximate; the surface is 142 tools / 31 domains.

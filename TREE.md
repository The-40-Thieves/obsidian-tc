...
**Scale:** 1,308 tracked code files · 226,958 lines.

TypeScript 206,994 · JavaScript 14,542 · Python 2,257 · SQL 1,940 · Rust 742 · Shell 483.
...
| `vault/` | 17 | 2,229 | filesystem primitives — paths, links, ACL, snapshots, prune |

...
**Scale:** 1,125 tracked code files · 175,166 lines.

TypeScript 161,740 · JavaScript 9,141 · Python 1,640 · SQL 1,543 · Rust 742 · Shell 360.
...
Derived from `git ls-files packages/server/src` over `.ts`/`.sql`, tests excluded — 389 files across 31 subsystems. Top-level files (`cli.ts`, `hash.ts`, …) belong to no subsystem and are not counted here.
...
**400 modules · 1771 dependencies · 118 distinct subsystem pairs · 792 cross-subsystem imports.**

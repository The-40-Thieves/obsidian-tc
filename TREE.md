...
**Scale:** 1,298 tracked code files · 221,576 lines.

TypeScript 201,612 · JavaScript 14,542 · Python 2,257 · SQL 1,940 · Rust 742 · Shell 483.
...
|---|---:|---:|---|
| `tools/` | 91 | 18,813 | domains m1–m8 + admin. The MCP tool surface |

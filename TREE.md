...
**Scale:** 1,094 tracked code files · 168,897 lines.

TypeScript 156,231 · JavaScript 8,381 · Python 1,640 · SQL 1,543 · Rust 742 · Shell 360.
...
Derived from `git ls-files packages/server/src` over `.ts`/`.sql`, tests excluded — 382 files across 31 subsystems. Top-level files (`cli.ts`, `hash.ts`, …) belong to no subsystem and are not counted here.
...
**392 modules · 1748 dependencies · 118 distinct subsystem pairs · 785 cross-subsystem imports.**

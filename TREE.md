...
**Scale:** 1,085 tracked code files · 167,554 lines.

TypeScript 155,357 · JavaScript 8,078 · Python 1,640 · SQL 1,377 · Rust 742 · Shell 360.
...
| `cli/` | 24 | 3,106 | arg parsing + subcommands |
...
| `workspace/` | 3 | 1,029 | session tracking |

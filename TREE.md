...
**Scale:** 1,100 tracked code files · 169,747 lines.

TypeScript 156,751 · JavaScript 8,711 · Python 1,640 · SQL 1,543 · Rust 742 · Shell 360.
...
| `search/` | 54 | 10,635 | retrieval + indexing. Includes `graph_search_stages/` (THE-465) and `indexing/` (WP3) |

...
**Scale:** 995 tracked code files · 147,179 lines.

TypeScript 137,500 · JavaScript 6,154 · Python 1,526 · SQL 1,017 · Rust 668 · Shell 314.
...
| `search/` | 53 | 9,579 | retrieval + indexing. Includes `graph_search_stages/` (THE-465) and `indexing/` (WP3) |

...
**Scale:** 1,029 tracked code files · 155,579 lines.

TypeScript 144,448 · JavaScript 7,260 · Python 1,640 · SQL 1,175 · Rust 742 · Shell 314.
...
Derived from `git ls-files packages/server/src` over `.ts`/`.sql`, tests excluded — 355 files across 31 subsystems. Top-level files (`cli.ts`, `hash.ts`, …) belong to no subsystem and are not counted here.
...
**375 modules · 1673 dependencies · 111 distinct subsystem pairs · 752 cross-subsystem imports.**

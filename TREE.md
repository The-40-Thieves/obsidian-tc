...
**Scale:** 1,355 tracked code files · 240,524 lines.

TypeScript 219,501 · JavaScript 15,441 · Python 2,406 · SQL 1,940 · Rust 753 · Shell 483.
...
| `mcp/` | 25 | 6,297 | registry + facade + transport binding. `registry/` holds the dispatch pipeline (WP4) |

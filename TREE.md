...
**Scale:** 1,032 tracked code files · 155,906 lines.

TypeScript 144,775 · JavaScript 7,260 · Python 1,640 · SQL 1,175 · Rust 742 · Shell 314.
...
|---|---:|---:|---|
| `tools/` | 82 | 15,792 | domains m1–m8 + admin. The MCP tool surface |

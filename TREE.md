...
**Scale:** 1,134 tracked code files · 176,906 lines.

TypeScript 163,163 · JavaScript 9,380 · Python 1,640 · SQL 1,621 · Rust 742 · Shell 360.
...
|---|---:|---:|---|
| `tools/` | 85 | 16,859 | domains m1–m8 + admin. The MCP tool surface |

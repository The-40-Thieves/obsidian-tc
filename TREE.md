...
**Scale:** 1,305 tracked code files · 225,111 lines.

TypeScript 205,147 · JavaScript 14,542 · Python 2,257 · SQL 1,940 · Rust 742 · Shell 483.
...
| `mcp/` | 19 | 5,029 | registry + facade + transport binding. `registry/` holds the dispatch pipeline (WP4) |
...
| 525 | `packages/server/src/mcp/facade.ts` |
...
**457 modules · 2090 dependencies · 129 distinct subsystem pairs · 951 cross-subsystem imports.**

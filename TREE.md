...
**Scale:** 993 tracked code files · 146,649 lines.

TypeScript 136,970 · JavaScript 6,154 · Python 1,526 · SQL 1,017 · Rust 668 · Shell 314.
...
| `mcp/` | 17 | 4,120 | registry + facade + transport binding. `registry/` holds the dispatch pipeline (WP4) |
...
| `metrics/` | 4 | 848 | Prometheus catalog + `/metrics` endpoint, gauge sources, ingest stats |
...
| 616 | `packages/server/src/metrics/registry.ts` |
...
| 580 | `packages/server/src/mcp/registry/dispatch.ts` |

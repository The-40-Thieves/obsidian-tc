...
**Scale:** 1,230 tracked code files · 199,376 lines.

TypeScript 184,132 · JavaScript 10,605 · SQL 1,897 · Python 1,640 · Rust 742 · Shell 360.
...
|---|---:|---:|---|
| `tools/` | 90 | 18,048 | domains m1–m8 + admin. The MCP tool surface |

...
**Scale:** 1,305 tracked code files · 225,107 lines.

TypeScript 205,143 · JavaScript 14,542 · Python 2,257 · SQL 1,940 · Rust 742 · Shell 483.
...
| `mcp/` | 19 | 5,025 | registry + facade + transport binding. `registry/` holds the dispatch pipeline (WP4) |

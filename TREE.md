...
**Scale:** 1,331 tracked code files · 233,552 lines.

TypeScript 213,172 · JavaScript 14,958 · Python 2,257 · SQL 1,940 · Rust 742 · Shell 483.
...
| `experiential/` | 28 | 7,202 | work-memory tier: activation, retrieval log, forget, citations |
...
| `doctor/` | 16 | 2,842 | `obsidian-tc doctor` — checks, report rendering, runner |
...
| lines | file |
|---:|---|
| 903 | `packages/shared/src/config/retrieval.schema.ts` |
...
**462 modules · 2120 dependencies · 131 distinct subsystem pairs · 969 cross-subsystem imports.**

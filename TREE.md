...
**Scale:** 1,009 tracked code files · 150,500 lines.

TypeScript 140,772 · JavaScript 6,161 · Python 1,526 · SQL 1,059 · Rust 668 · Shell 314.
...
|---|---:|---:|---|
| `tools/` | 79 | 15,371 | domains m1–m8 + admin. The MCP tool surface |

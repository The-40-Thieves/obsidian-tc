...
**Scale:** 1,004 tracked code files · 149,898 lines.

TypeScript 140,219 · JavaScript 6,154 · Python 1,526 · SQL 1,017 · Rust 668 · Shell 314.
...
|---|---:|---:|---|
| `tools/` | 79 | 15,369 | domains m1–m8 + admin. The MCP tool surface |

...
**Scale:** 1,307 tracked code files · 225,701 lines.

TypeScript 205,737 · JavaScript 14,542 · Python 2,257 · SQL 1,940 · Rust 742 · Shell 483.
...
| `mcp/` | 20 | 5,354 | registry + facade + transport binding. `registry/` holds the dispatch pipeline (WP4) |
...
**458 modules · 2092 dependencies · 129 distinct subsystem pairs · 951 cross-subsystem imports.**

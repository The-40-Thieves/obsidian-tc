...
description: The ~123-tool surface obsidian-tc exposes to MCP clients, and the facade that shapes it.
---

obsidian-tc groups **~123 tools across modules M1–M7 plus admin**. Every tool has

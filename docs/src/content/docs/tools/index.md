...
description: The ~162-tool surface obsidian-tc exposes to MCP clients, and the facade that shapes it.
---

obsidian-tc groups **162 tools across modules M1–M8 plus admin**. Every tool has

---
title: Tool Catalog
description: The complete, generated list of every MCP tool obsidian-tc exposes — name, access, scopes, and description.
sidebar:
  order: 3
---
...
between the markers — change the tool and regenerate.
:::

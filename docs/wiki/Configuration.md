...
| `experiential.citationInfer.judge.baseUrl` | `string` | `"https://api.typesafe.ai"` |  | TypeSafe API base URL. Must be https:// unless the host is loopback (a local test/dev endpoint) — this URL carries the bearer key and vault-derived text. |

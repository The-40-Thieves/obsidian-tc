...
const EXPECTED: ToolSnapshot[] = [
  ...
  },
  {
    ...
    outputKeys: ["bytes_written", "content_hash", "created", "mode_used", "path", "prev_hash", "vault"],
  },
  {
    name: "append_note",
    ...
    hasPathAcl: true,
    destructive: false,
    inputKeys: ["content", "create_if_missing", "ensure_newline", "options", "path", "prev_hash", "vault"],
    outputKeys: ["bytes_written", "content_hash", "created", "path", "prev_hash", "vault"],
  },
  {
    name: "patch_note",
    description:
    ...
    hasPathAcl: true,
    destructive: false,
    inputKeys: ["anchor", "confirm_replace", "content", "operation", "path", "prev_hash", "target_heading", "vault"],
    outputKeys: [
      "anchor",
      "bytes_removed",
      "content_hash",

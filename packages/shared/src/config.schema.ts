...
// WP1.1: auth+ACL schemas now live in ./config/auth-acl.schema.ts; re-exported here so this
// stays a compatibility facade and every existing import of these names keeps working.
export { AclConfigSchema, AclRuleSchema, AuthConfigSchema };

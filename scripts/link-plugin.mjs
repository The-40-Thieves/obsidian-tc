 ...
 * `.obsidian/plugins/obsidian-tc/` directory, the manual step CONTRIBUTING.md's "Running the
 * plugin in Obsidian" section otherwise has a contributor build by hand every time
 * ("Symlink packages/plugin/dist/ into your test vault's .obsidian/plugins/obsidian-tc/
 * directory").
 *
...
const target = join(pluginsDir, "obsidian-tc");
...
console.log(
  'Enable "Obsidian Turbocharged" under Community Plugins, then restart Obsidian on manifest changes.',
);
